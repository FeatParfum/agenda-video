...
export default async function LoginPage({
  ...
  return (
    <div
      className="relative flex-1 flex items-start justify-center lg:items-start lg:justify-start bg-[#f5e8dc] bg-cover bg-center bg-no-repeat px-4 pt-32 pb-10 sm:px-8 sm:pt-36 lg:px-[6%] lg:pt-[41vh]"
